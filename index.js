...
class Car {
  ...
  drive(distance) {
    ...
    if (this.distance < DriveableDistance){
...
//const Bill = new Student({name: 'Bill', age: 10, location: 'London',previousBackground:'Kindergarten', className:'webdev', favSubjects: ['HTML', 'CSS', 'JS']})

//console.log(Bill.PRAssignment('spanish'))
